...
public static class Craptography
{
	...
	// Token: 0x06002845 RID: 10309 RVA: 0x000CF518 File Offset: 0x000CD718
	public static void XOR(uint seed, MemoryStream src, int srcOffset, MemoryStream dst, int dstOffset)
	{
		...
		int num2 = Craptography.hash.Length;
		...
		for (int i = 0; i < num; i++)
		{
			buffer2[dstOffset + i] = (buffer[srcOffset + i] ^ Craptography.hash[(num3 + i) % num2]);
		}
	}
}
